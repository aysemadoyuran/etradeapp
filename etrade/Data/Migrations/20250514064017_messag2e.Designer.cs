...
namespace etrade.Data.Migrations
{
    ...
    [Migration("20250514064017_messag2e")]
    partial class messag2e
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("etrade.Entity.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("etrade.Entity.TenantCustomer", b =>
                {
                    ...
                    b.HasOne("etrade.Models.TenantUser", "User")
                        .WithOne("TenantCustomer")
                        .HasForeignKey("etrade.Entity.TenantCustomer", "UserId");
