...
namespace etrade.Data.Migrations
{
    ...
    [Migration("20250425092541_CreateJsonSetting")]
    partial class CreateJsonSetting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("etrade.Entity.Coupon", b =>
                {
                    ...
                    b.Property<int?>("MinimumProductCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("etrade.Entity.CouponUsage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("etrade.Entity.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("etrade.Entity.RefundRequest", b =>
                {
            ...
            modelBuilder.Entity("etrade.Entity.RefundedItem", b =>
                {
                    b.Property<int>("RefundedItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("RefundedItemId"));
            ...
            modelBuilder.Entity("etrade.Entity.Slider", b =>
                {
                    ...
                    b.Property<string>("SliderCategory")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("etrade.Entity.StoreSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("etrade.Entity.UserCoin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("etrade.Entity.CouponUsage", b =>
                {
                    b.HasOne("etrade.Entity.Coupon", "Coupon")
            ...
            modelBuilder.Entity("etrade.Entity.RefundRequest", b =>
                {
                    ...
                    b.HasOne("etrade.Entity.PaymentMethod", "PaymentMethod")
                        .WithMany()
            ...
            modelBuilder.Entity("etrade.Entity.RefundedItem", b =>
                {
                    ...
                    b.HasOne("etrade.Entity.RefundRequest", "RefundRequest")
                        .WithMany("RefundedItems")
            ...
            modelBuilder.Entity("etrade.Entity.UserCoin", b =>
                {
                    b.HasOne("etrade.Models.AppUser", "User")
                        .WithOne("UserCoin")
                        .HasForeignKey("etrade.Entity.UserCoin", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
